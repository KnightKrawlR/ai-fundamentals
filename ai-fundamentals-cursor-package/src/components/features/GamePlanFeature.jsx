      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          <motion.div
            ...
            viewport={{ once: true, margin: "-100px" }}
          >
            <h3 className="text-2xl font-bold text-purple-800 mb-8 flex items-center">
              <span className="bg-purple-100 w-10 h-10 rounded-full flex items-center justify-center mr-3">
            ...
            <div className="space-y-8">
              <motion.div 
                ...
                viewport={{ once: true }}
              >
                <div className="bg-gradient-to-br from-purple-100 to-purple-200 rounded-full p-3 mr-4 shadow-sm">
                  <span className="flex items-center justify-center w-8 h-8 bg-gradient-to-br from-purple-600 to-purple-800 text-white rounded-full font-bold">1</span>
                </div>
                <div>
              ...
              >
                <div className="bg-gradient-to-br from-purple-100 to-purple-200 rounded-full p-3 mr-4 shadow-sm">
                  <span className="flex items-center justify-center w-8 h-8 bg-gradient-to-br from-purple-600 to-purple-800 text-white rounded-full font-bold">2</span>
                </div>
                <div>
              ...
              >
                <div className="bg-gradient-to-br from-purple-100 to-purple-200 rounded-full p-3 mr-4 shadow-sm">
                  <span className="flex items-center justify-center w-8 h-8 bg-gradient-to-br from-purple-600 to-purple-800 text-white rounded-full font-bold">3</span>
                </div>
                <div>
              ...
              >
                <div className="bg-gradient-to-br from-purple-100 to-purple-200 rounded-full p-3 mr-4 shadow-sm">
                  <span className="flex items-center justify-center w-8 h-8 bg-gradient-to-br from-purple-600 to-purple-800 text-white rounded-full font-bold">4</span>
                </div>
                <div>
            ...
            >
              <Button 
                variant="primary" 
                size="large"
                className="px-8 py-4 rounded-full shadow-lg shadow-purple-900/10 hover:shadow-purple-600/20 transition-all duration-300"
